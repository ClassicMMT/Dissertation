...
for n_epoch in epochs:
    ...
    # Model
    model = GenericNet(layers=[2, 1024, 512, 256, n], activation="relu", random_state=random_state).to(device)
...
if True:
    ...
    fig.text(0.005, 0.825, "Entropy", va="center", rotation="vertical", fontsize=14)
    fig.text(0.005, 0.5, "Information content", va="center", rotation="vertical", fontsize=14)
    fig.text(0.005, 0.175, "Probability gaps", va="center", rotation="vertical", fontsize=14)
